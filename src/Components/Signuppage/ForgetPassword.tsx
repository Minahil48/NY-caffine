                ...
                <div className="flex items-center justify-center py-20">
                    <div className="flex flex-col gap-10 md:gap-16 w-full max-w-md px-6">
                        <div className="text-center md:text-center">
                            <h1 className="text-3xl font-semibold mb-2 text-gray-900">Reset Your Password</h1>
                            <p className="text-gray-700 mb-6 text-xl whitespace-nowrap">An email will be sent to the email you provide</p>
                        </div>

                        <form className="flex flex-col space-y-5 md:space-y-7 w-full" action="#">
                            <div>
                                <label
                                    htmlFor="reset-email"
                            ...
                            <div className="flex justify-center mt-8">
                                <div className="flex justify-center">
                                    <Button onClick={() => (location.href = '/otp-page')} value="Reset Password" />
                                </div>
                            </div>
                        </form>
                    </div>
